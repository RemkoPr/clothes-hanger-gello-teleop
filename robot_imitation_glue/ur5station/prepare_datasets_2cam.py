...
features_to_drop = ["wrist_wilson_image_original", "wrist_sophie_image_original", "wrist_wilson_image", "scene_image_original"]
...
transform_dataset(
    ...
    new_root_dir=f"datasets/clothes-hanger-v3p4-w{resize[0]}h{resize[1]}-2cam",
    repo_id="clothes-hanger-repo-v3p4",
    transform_fn=joints_frame_transform,  # 
    transform_features_fn=features_transform,
    features_to_drop=features_to_drop,
    episodes_to_drop=[140, 171]#[i for i in range(2, 179)], #
)
