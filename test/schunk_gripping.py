...
ORIGINAL_CLOTHES_HANGER_GRASP_WIDTH = 0.018
BCH_GRASP_WIDTH = 0.0055
BCHe_GRASP_WIDTH = 0.0060
BCHe2_GRASP_WIDTH = 0.009
MCHe_GRASP_WIDTH = 0.00
GCHe_GRASP_WIDTH = 0.011
...
gripper1 = SchunkGripperProcess(SCHUNK_SOPHIE_PORT)

gripper1.move(BCHe2_GRASP_WIDTH + 0.00).wait()
time.sleep(0.5)
gripper1.shutdown()
